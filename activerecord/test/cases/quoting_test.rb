...
module ActiveRecord
  module ConnectionAdapters
    class QuotingTest < ActiveRecord::TestCase
      ...
      def test_quote_string_fun_numeric_coerce
        assert_equal "2730", @quoter.quote("0xAAA", FakeColumn.new(:integer))
        assert_equal "4", @quoter.quote("0b100", FakeColumn.new(:integer))
      end
